 ...
 *
 *   serverFns (the agent's command + event endpoints) → built assets → the SSR document
 *
 * Importing the build's registry also evaluates the server-only module, so
 * the agent and its session exist before the first request.
 */

...
| `codex-cli` | `@sigx/ai-agent-codex-cli` | `codex` (`npm i -g @openai/codex`) | `OPENAI_API_KEY`, `CODEX_HOME` |
| `copilot-cli` | `@sigx/ai-agent-copilot-cli` | the SDK's bundled Copilot CLI runtime (`copilot login` to sign in) | `COPILOT_GITHUB_TOKEN`, `GH_TOKEN`, `GITHUB_TOKEN`, `COPILOT_HOME` |
...
| `acp:codex-cli` | `@sigx/ai-agent-acp` | `codex-acp` (`npm i -g @agentclientprotocol/codex-acp`) | `OPENAI_API_KEY`, `CODEX_HOME` |
| `acp:copilot-cli` | `@sigx/ai-agent-acp` | `copilot --acp` (`npm i -g @github/copilot`) | `COPILOT_GITHUB_TOKEN`, `GH_TOKEN`, `GITHUB_TOKEN`, `COPILOT_HOME` |

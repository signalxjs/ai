...
export default defineConfig({
    ...
    resolve: {
        ...
        alias: [
            ...
            { find: '@sigx/ai-agent-codex-cli', replacement: resolve(__dirname, 'packages/ai-agent-codex-cli/src/index.ts') },
            { find: '@sigx/ai-agent-copilot-cli', replacement: resolve(__dirname, 'packages/ai-agent-copilot-cli/src/index.ts') },

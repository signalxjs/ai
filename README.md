...
- [`examples/chat`](./examples/chat) — an SSR sigx app streaming a chat over `serverStream`, assistant text rendered as markdown via `@sigx/markdown/dom`, provider switched by env, a scripted mock when no key is set.

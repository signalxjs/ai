...
describe('the web pack', () => {
    it('covers every base component', () => {
        ...
        expect(webStyles).toContain('.json-ui-button--primary');
    });
    ...
    it('stack maps layout props onto flex styles and merges the spec style last', () => {
        ...
        expect(v.props.class).toBe('json-ui-stack x');
    ...
    it('button: variant class, disabled while pending, press', () => {
        ...
        expect(v.props.class).toBe('json-ui-button json-ui-button--danger json-ui-button--sm is-pending');

 ...
 *
 * A copy of `packages/ai-agent/src/utils/abort.ts` (itself a copy of the core's
 * engine abort file). They stay in step by hand; this package must not
 * reach into another package's private files.
 */

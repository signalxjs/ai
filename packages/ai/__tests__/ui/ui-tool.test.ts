...
import { SchemaValidationError, generateText } from '../../src/index.js';
import { mockModel } from '../../src/testing/index.js';
import { uiTool, uiToolJsonSchema, type UIToolResult } from '../../src/ui/index.js';
import { baseCatalog } from '@sigx/json-ui';

const ctx = { signal: new AbortController().signal, toolCallId: 'c1' };

describe('uiTool', () => {
    it('its wire schema wraps the spec schema in { spec } and hoists $defs so $refs resolve', () => {

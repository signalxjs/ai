/**
 * `uiTool` — the spec as a tool the model calls. The tool loop streams the
...
import { defineTool, type JsonSchema, type StandardSchemaV1, type Tool, type ToolContext } from '@sigx/ai';
import { baseCatalog, describeCatalog, specJsonSchema, uiSpecSchema, validateSpec, type UICatalog } from '../catalog/index.js';
import type { UIIssue, UISpec } from '../spec/types.js';

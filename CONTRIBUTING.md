...
```bash
git clone https://github.com/signalxjs/ai.git ai/main
cd ai/main
pnpm install
pnpm build
```
...
- **Bug?** Open an issue with the [bug report template](https://github.com/signalxjs/ai/issues/new?template=bug_report.yml). A minimal reproduction helps a lot.
- **Feature idea?** Use the [feature request template](https://github.com/signalxjs/ai/issues/new?template=feature_request.yml).
